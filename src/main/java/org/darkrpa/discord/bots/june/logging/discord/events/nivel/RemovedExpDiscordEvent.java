...
public class RemovedExpDiscordEvent extends GenericGuildDiscordEvent{
    private int cantidad;

    public RemovedExpDiscordEvent(JDA api, long responseNumber, Guild guild, String admin, String usuarioAfectado,
        int cantidad) {
