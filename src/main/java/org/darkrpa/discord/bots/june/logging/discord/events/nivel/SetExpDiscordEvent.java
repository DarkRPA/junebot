...
public class SetExpDiscordEvent extends GenericGuildDiscordEvent{
    private int cantidad;

    public SetExpDiscordEvent(JDA api, long responseNumber, Guild guild, String admin, String usuarioAfectado,
        int cantidad) {
