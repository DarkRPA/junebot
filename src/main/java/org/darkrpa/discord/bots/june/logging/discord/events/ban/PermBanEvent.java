...
public class PermBanEvent extends GenericGuildDiscordEvent{

    public PermBanEvent(JDA api, long responseNumber, Guild guild, String admin, String usuarioAfectado,
            String motivo) {
